const contratEarlyModel = require ("../models/contratEarlybooking_model")
...
module.exports={
         ...
         create: async (req, res) => {
            ...
            try {
                const contrat = new contratEarlyModel(req.body)
         ...
         getall: function(req,res){
            contratEarlyModel.find({},(err,items)=>{
              if(err){
         ...
         update:function(req,res){
            ...
            contratEarlyModel.findByIdAndUpdate(req.params.id,req.body,{new:true},function(err,item){
             if(err){
         ...
         getbyname:function(req,res){
            contratEarlyModel.find({nom:req.query.nom},function(err,item){
         ...
         getbyid:function(req,res){
            contratEarlyModel.findById(req.params.id,function(err,item){
         ...
         delete:function(req,res){
            contratEarlyModel.findByIdAndRemove(req.params.id,function(err,item){
                 if(err){
