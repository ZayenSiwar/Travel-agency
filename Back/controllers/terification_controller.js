const reservationModel = require ("../models/terification_model")
...
module.exports={
         ...
         create: async (req, res) => {
            ...
            try {
                ...
                await reservation.save(req.body, (err, item) => {
                    if (err) {
         ...
         getall: function(req,res){
            reservationModel.find({},(err,items)=>{
              if(err){
         ...
         getbyname:function(req,res){
            reservationModel.find({nom:req.query.nom},function(err,item){
         ...
         getbyid:function(req,res){
            reservationModel.findById(req.params.id,function(err,item){
